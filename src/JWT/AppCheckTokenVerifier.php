...
use Kreait\Firebase\JWT\Action\FetchGoogleJWKPublicKeys\WithPsr6Cache;
use Kreait\Firebase\JWT\Action\VerifyIdToken;
use Kreait\Firebase\JWT\Action\VerifyIdToken\Handler;
use Kreait\Firebase\JWT\Action\VerifyIdToken\WithAppCheckJWT;
...
final class AppCheckTokenVerifier
{
    ...
    public static function createWithProjectId(string $projectId): self
    {
        ...
        $keys = new GoogleJWKPublicKeys($keyHandler, $clock);
        $handler = new WithAppCheckJWT($projectId, $keys, $clock);
